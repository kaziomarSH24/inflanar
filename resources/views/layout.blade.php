                        ...
                        <nav id="offcanvas-menu" class="offcanvas-menu">
                            ...
                            <ul class="nav-menu menu navigation list-none">
                                ...
                                <li class="menu-item-has-children active"><a
                                    ...
                                    <ul class="sub-menu">
                                        <li><a href="{{ route('home', ['theme' => 'one']) }}">{{__('admin.Homepage
                                                V1')}}</a></li>
                                        <li><a href="{{ route('home', ['theme' => 'two']) }}">{{__('admin.Homepage
                                                V2')}}</a></li>
                                        <li><a href="{{ route('home', ['theme' => 'three']) }}">{{__('admin.Homepage
                                                V3')}}</a></li>
                                    </ul>
                                </li>
                                @else
                                ...
                                <li class="menu-item-has-children"><a href="#">{{__('admin.Pages')}}</a>
                                    <ul class="sub-menu">
                                        ...
                                        <li><a href="{{ route('terms-conditions') }}">{{__('admin.Terms &
                                                Conditions')}}</a></li>
                                        <li><a href="{{ route('privacy-policy') }}">{{__('admin.Privacy Policy')}}</a>
                                        </li>
                                        {{-- @foreach ($custom_pages as $custom_page)
                                        <li><a href="{{ route('custom-page', $custom_page->slug) }}">{{
                                ...
                                <li>
                                    <div class="qnav-btn-item ">
                                        ...
                                        @guest('web')
                                        <a href="{{ route('login') }}" class="inflanar-btn inflanar-btn--header text-white"><span>
                                                {{__('admin.Login')}}</span></a>
                                        @else
                                        @php
                                        ...
                                        <a href="{{ route('influencer.dashboard') }}"
                                            class="inflanar-btn inflanar-btn--header text-white"><span>{{__('admin.Dashboard')}}</span></a>
                                        @else
                                            ...
                                            <div class="navbar">
                                                <div class="nav-item">
                                                    ...
                                                    <ul class="nav-menu menu navigation list-none">
                                                        ...
                                                        <li><a
                                                                href="{{ route('influencers') }}">{{__('admin.Business')}}</a>
                                                        </li>

                                                        <li><a
                                                                href="{{ route('services') }}">{{__('admin.Services')}}</a>
                                                        </li>

                                                        <li class="menu-item-has-children"><a
                                                                href="#">{{__('admin.Pages')}}</a>
                                                            <ul class="sub-menu">
                                                                ...
                                                                <li><a href="{{ route('about-us') }}">{{__('admin.About
                                                                        Us')}}</a></li>

                                                                <li><a href="{{ route('blogs') }}">{{__('admin.Our
                                                                        Blogs')}}</a></li>
                                                                <li><a href="{{ route('faq') }}">{{__('admin.FAQ')}}</a>
                                                                </li>
                                                                <li><a href="{{ route('terms-conditions') }}">{{__('admin.Terms
                                                                        & Conditions')}}</a></li>
                                                                <li><a href="{{ route('privacy-policy') }}">{{__('admin.Privacy
                                                                        Policy')}}</a></li>
                                                                {{-- @foreach ($custom_pages as $custom_page)
                                                                <li><a
                                                                        href="{{ route('custom-page', $custom_page->slug) }}">{{
                                                                        $custom_page->page_name }}</a></li>
                                                                @endforeach --}}
                                                        ...
                                                        <li><a
                                                                href="{{ route('contact-us') }}">{{__('admin.Contact')}}</a>
                                                        </li>
                                                    </ul>
                                                    <!-- End Main Menu -->
                                                </div>
                                    ...
                                    <div class="inflanar-header__button h-with-lang-switch">
                                        ...
                                        <div class="currency-item">
                                            ...
                                            <form action="{{ route('currency-switcher') }}" id="currency_swithcer_form">
                                                ...
                                                <select name="currency_code" id="currency_swithcer"
                                                    ...
                                                    @foreach ($currency_list as $currency_item)
                                                    @if (Session::get('currency_code'))
                                                    <option {{ Session::get('currency_code')==$currency_item->
                                        ...
                                        <div class="qnav-btn-item">
                                            ...
                                            <form action="{{ route('language-switcher') }}" id="lang_swithcer_form">
                                                <div class="inflanar-header__lang">
                                                    <i class="fas fa-globe"></i>
                                                    <select id="lang_swithcer" class="inflanar-header__lang--list"
                                                        name="lang_code">
                                                        @if (Session::get('front_lang'))
                                                        @foreach ($language_list as $language)
                                                        <option {{ Session::get('front_lang')==$language->lang_code ?
                                                            'selected' : '' }} value="{{ $language->lang_code }}">{{
                                        ...
                                        <div class="qnav-btn-item">
                                            ...
                                            @guest('web')
                                            <a href="{{ route('login') }}"
                                                class="inflanar-btn inflanar-btn--header"><span>
                                                    {{__('admin.Login')}}</span></a>
                                            @else
                                            @php
                                            $auth_user = Auth::guard('web')->user();
                            ...
                            <div class="footer-cta__inner inflanar-bg-cover  inflanar-section-shape3">
                                <div class="footer-cta__content">
                                    ...
                                    <a href="{{ route('register') }}"
                                        class="inflanar-btn inflanar-btn__big"><span>{{__('admin.Join as
                                            Business')}}</span></a>
                                </div>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12">
                                        ...
                                        <div class="single-widget footer-useful-links">
                                            ...
                                            <ul class="footer__list list-none">
                                                <li><a href="{{ route('about-us') }}">{{__('admin.About Us')}}</a></li>
                                                <li><a href="{{ route('services') }}">{{__('admin.Our Services')}}</a>
                                                </li>
                                                <li><a href="{{ route('influencers') }}">{{__('admin.Our
                                                        Businesses')}}</a></li>
                                                <li><a href="{{ route('blogs') }}">{{__('admin.Our Blogs')}}</a></li>
                                                <li><a href="{{ route('contact-us') }}">{{__('admin.Contact Us')}}</a>
                                                </li>
                                                <li><a href="{{ route('terms-conditions') }}">{{__('admin.Terms And
                                                        Conditions')}}</a></li>
                                                <li><a href="{{ route('privacy-policy') }}">{{__('admin.Privacy
                                                        Policy')}}</a></li>
                                                <li><a href="{{ route('faq') }}">{{__('admin.FAQ')}}</a></li>
                                                <li><a href="{{ route('user.dashboard') }}">{{__('admin.My
                                                        Profile')}}</a></li>
                                                <li><a href="{{ route('user.change-password') }}">{{__('admin.Change
                                                        Password')}}</a></li>
                                            </ul>
                                        </div>
                                        <!-- End Footer Widget -->
                            ...
                            <div class="col-12">
                                <div class="copyright__inner">
                                    ...
                                    <ul class="inflanar-social inflanar-social__v2">
                                        @if ($setting->twitter)
                                        <li><a href="{{ $setting->twitter }}"><i class="fa-brands fa-twitter"></i></a>
                                        </li>
                                        @endif

                                        @if ($setting->behance)
                                        <li><a href="{{ $setting->behance }}"><i class="fa-brands fa-behance"></i></a>
                                        </li>
                                        @endif
                                        ...
                                        @if ($setting->linkedin)
                                        <li><a href="{{ $setting->linkedin }}"><i class="fa-brands fa-linkedin"></i></a>
                                        </li>
                                        @endif
                ...
                <div class="wsus__main_message">
                    <div class="wsus__message_list">
                        <ul id="provider_existing_list">
                            ...
                            $providers = App\Models\Message::with('provider')->where(['buyer_id' =>
                            $login_buyer->id])->select('provider_id')->groupBy('provider_id')->orderBy('id','desc')->get();
                            ...
                            <li class="provider-list single-provider-{{ $provider->provider_id }}"
                                ...
                                <div class="img">
                                    ...
                                    <img src="{{ asset($provider->provider->image) }}" alt="user"
                                    ...
                                    @php
                                    $un_read = App\Models\Message::where(['provider_id' => $provider->provider_id,
                                    'buyer_id' => $login_buyer->id, 'buyer_read_msg' => 0])->count();
                                    @endphp
                    ...
                    <div class="wsus__message_box">
                        ...
                        <div class="wsus__empty_message">
                            <div class="img">
                                <img src="{{ asset('uploads/website-images/empty_chat.png') }}" alt="empty"
                                    class="img-fluid w-100">
                            </div>
                        ...
                        <div class="wsus__message_preloader d-none">
                            <span>
                                <img src="{{ asset('uploads/website-images/preloader.gif') }}" alt="preloader"
                                    class="img-fluid w-100">
                            </span>
                        </div>
                        ...
                        <form id="chat-form">
                            @csrf
                            <input type="text" name="message" placeholder="{{__('admin.Type message')}}"
                                id="provider_message" autocomplete="off">
