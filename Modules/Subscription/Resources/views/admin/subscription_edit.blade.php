                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="type" id="userType" class="form-control">
                                            <option {{ $plan->type == 'business' ? 'selected' : ''}}
                                                value="business">{{__('admin.Business')}}</option>
                                            <option {{ $plan->type == 'influencer' ? 'selected' : ''}}
                                                value="influencer">{{__('admin.Influencer')}}</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="expiration_date" id="" class="form-control">
                                            <option {{ $plan->expiration_date == 'daily' ? 'selected' : ''}}
                                                value="daily">{{__('admin.Daily')}}</option>
                                            <option {{ $plan->expiration_date == 'monthly' ? 'selected' : ''}}
                                                value="monthly">{{__('admin.Monthly')}}</option>
                                            {{-- <option {{ $plan->expiration_date == 'yearly' ? 'selected' : ''}}
                                                value="yearly">{{__('admin.Yearly')}}</option> --}}
                                            <option {{ $plan->expiration_date == 'lifetime' ? 'selected' : ''}}
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="status" id="" class="form-control">
                                            <option {{ $plan->status == 1 ? 'selected' : ''}}
                                                value="1">{{__('admin.Active')}}</option>
                                            <option {{ $plan->status == 0 ? 'selected' : ''}}
                                            ...
                                            @if($plan->description)
                                                ...
                                                <div class="form-group col-8">
                                                    ...
                                                    <input type="text" class="form-control" name="description[]"
                                                        autocomplete="off" value="{{ $des }}">
                                                </div>
                                                <div class="col-4">
                                                    <button type="button" class="btn btn-danger removeDescriptionBtn btn_mt_33"><i
                                                            class="fa fa-trash" aria-hidden="true"></i>
                                                        {{__('admin.Remove')}}</button>
                                                </div>
                                                @endforeach
                                            @endif
                                            <div class="form-group col-8">
