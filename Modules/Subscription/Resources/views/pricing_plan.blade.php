                        ...
                        <div class="inflanar-section__head inflanar-section__center mg-btm-20">
                            <span class="inflanar-section__badge inflanar-primary-color m-0" data-aos="fade-in"
                                ...
                                <span>{{__('admin.Subscription')}}</span> <img
                                    src="{{ asset('frontend/img/in-section-vector.svg') }}">
                            </span>
        ...
        <div class="tab-content mg-top-30" id="myTabContent">
            <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab"
                ...
                <div class="row">
                    ...
                    @endforeach
                    @elseif (auth()->user() && auth()->user()->is_influencer == 'no') {{-- here influencer means
                    business role --}}
                    ...
                    @endforeach
                    @else
                    {{-- business provider subcription plan --}}
                    <div class="row">
                        <div class="col-12">
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="inflanar-section__head inflanar-section__center mg-btm-20">
                                        ...
                                        <h2 class="inflanar-section__title" data-aos="fade-in" data-aos-delay="400">
                                            {{__('admin.Subscription Plan For Business Provider')}}</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-lg-3 col-md-6 mb-3 mb-lg-0">
                                    <div class="pricing-pack highlighted">
                                        <div class="price-header-wrapper">
                                            ...
                                            <svg class="price-shape" width="307" height="193" viewBox="0 0 307 193"
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="inflanar-section__head inflanar-section__center mg-btm-20">
                                        ...
                                        <h2 class="inflanar-section__title" data-aos="fade-in" data-aos-delay="400">
                                            {{__('admin.Subscription Plan For Influencer')}}</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
